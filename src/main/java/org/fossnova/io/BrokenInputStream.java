...
/**
 * A <code>BrokenInputStream</code> always throws <code>IOException</code>.
 * <p>
...
public final class BrokenInputStream extends InputStream {
    ...
    private BrokenInputStream() {
        exception = new IOException( "Broken input stream" );
    }

    /**
     * Returns <code>BrokenInputStream</code> singleton instance.
     */
